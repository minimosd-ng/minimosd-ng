...
unsigned char widget_default_config[] EEMEM = {
  ...
  1, BATVOLTAGE_WIDGET_ID,     1, 11,
  1, BATCURRENT_WIDGET_ID,     1, 12,
  1, GPSCOORDS_WIDGET_ID,      1, 13,

  1, HEADING_WIDGET_ID,       19, 14,
  1, FLIGHTMODE_WIDGET_ID,    23, 13,
  1, WINDROSE_WIDGET_ID,      23, 14,
